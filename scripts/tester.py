...
def run_test(system='etcd', topo='simple', nn='3', nc='1', write_rate='1', failure='none', mtbf='1', client='go', ncpr='False', rate='1000', duration='60', tag='', write_ratio='1', debug=False):
    config = {
        "system" : system,
        "topo" : topo,
        "nn" : nn,
