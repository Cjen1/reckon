...
type Response struct {
	...
	ClientStart          float64  `protobuf:"fixed64,3,opt,name=client_start,json=clientStart,proto3" json:"client_start,omitempty"`
	QueueStart           float64  `protobuf:"fixed64,4,opt,name=queue_start,json=queueStart,proto3" json:"queue_start,omitempty"`
	End                  float64  `protobuf:"fixed64,5,opt,name=end,proto3" json:"end,omitempty"`
	Clientid             uint32   `protobuf:"varint,6,opt,name=clientid,proto3" json:"clientid,omitempty"`
